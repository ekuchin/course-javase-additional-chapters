...
public class Analyzer {
    ...
    public Analyzer(Properties props) {
        this.REPORT_STEP=Integer.parseInt(props.getProperty("report.step"));
        this.MAX_PATH_LENGTH=Integer.parseInt(props.getProperty("max.path.length"));
        this.MAX_FILENAME_LENGTH=Integer.parseInt(props.getProperty("max.filename.length"));
        this.MAX_FOLDER_NESTING_LEVEL=Integer.parseInt(props.getProperty("max.path.nested"));
        this.ALLOW_SYMBOLS = props.getProperty("allow.symbols");

        File file = new File(props.getProperty("path"));
        String rootPath = file.getAbsolutePath();
        this.rootFolder = rootPath.substring(0,rootPath.lastIndexOf(File.separator));
    }

    public String analyze(File fileIn, int offset){
    ...
    public String generateLogEntry(File file, int offset){
        ...
        String filepath_wo_root = file.getAbsolutePath().substring(rootFolder.length());
